...
export const createFavorite = /* GraphQL */ `
  mutation CreateFavorite($input: CreateFavoriteInput!, $condition: ModelFavoriteConditionInput) {
...
export const updateFavorite = /* GraphQL */ `
  mutation UpdateFavorite($input: UpdateFavoriteInput!, $condition: ModelFavoriteConditionInput) {
...
export const deleteFavorite = /* GraphQL */ `
  mutation DeleteFavorite($input: DeleteFavoriteInput!, $condition: ModelFavoriteConditionInput) {
...
export const createReservation = /* GraphQL */ `
  mutation CreateReservation($input: CreateReservationInput!, $condition: ModelReservationConditionInput) {
...
export const updateReservation = /* GraphQL */ `
  mutation UpdateReservation($input: UpdateReservationInput!, $condition: ModelReservationConditionInput) {
...
export const deleteReservation = /* GraphQL */ `
  mutation DeleteReservation($input: DeleteReservationInput!, $condition: ModelReservationConditionInput) {
